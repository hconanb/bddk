...
void AddModel(RooWorkspace* ws){
  ...
  Double_t lowRange = 5230, highRange = 5330;
  ...
  RooRealVar K_PT("K_PT", "K_PT", 0., 10000., "MeV");
  RooRealVar K_MINIPCHI2("K_MINIPCHI2","K_MINIPCHI2",0.,10000.);
  RooRealVar K_IPCHI2_ORIVX("K_IPCHI2_ORIVX","K_IPCHI2_ORIVX",23);
  RooRealVar B_ENDVERTEX_CHI2("B_ENDVERTEX_CHI2","B_ENDVERTEX_CHI2",0.,30.);

  std::cout << "make signal model" << std::endl;

  // SIGNAL MODEL
  RooRealVar mB("mB", "B Mass", 5280., 5278., 5281.);
  RooRealVar sigmaB1("sigmaB1", "Width of Gaussian1", 6.3,0.0,15.0,"MeV");
  RooRealVar sigmaB2("sigmaB2", "Width of Gaussian2", 12.3,0.0,15.0,"MeV");
  ...
  RooRealVar f1("f1","fraction",0.5,0.,1.);
  ...
  RooRealVar sigYield("sigYield","fitted yield for sig",170000 ,0, 210000) ;
  RooRealVar bkgYield("bkgYield","fitted yield for bkg",30000 ,0, 210000) ;
...
void AddData(RooWorkspace* ws){
  ...
  RooRealVar K_PT("K_PT", "K_PT", 0., 10000., "MeV");
  RooRealVar K_MINIPCHI2("K_MINIPCHI2","K_MINIPCHI2",0.,10000.);
  RooRealVar K_IPCHI2_ORIVX("K_IPCHI2_ORIVX","K_IPCHI2_ORIVX",0.,32.);
  RooRealVar B_ENDVERTEX_CHI2("B_ENDVERTEX_CHI2","B_ENDVERTEX_CHI2",0.,30.);
  cout<<"poop2_1"<<endl;

  const char* cuts = "(B_DTF_M_JpsiConstr>5200 && B_DTF_M_JpsiConstr<5400 && K_MINIPCHI2 < 10000 && K_PT < 10000)";
  cout<<"poop3"<<endl;
  ...
  RooArgSet s(B_DTF_M_JpsiConstr,K_PT,K_IPCHI2_ORIVX,B_ENDVERTEX_CHI2,K_MINIPCHI2);

  RooDataSet data("data","dataset with x",s,Import(*tree),Cut(cuts)) ;
...
void DoSPlot(RooWorkspace* ws){
 ...
 Double_t K_PT, K_MINIPCHI2, K_IPCHI2_ORIVX, B_ENDVERTEX_CHI2, B_MASS, SIGW, BKGW;

 treeout->Branch("B_MASS",&B_MASS,"B_MASS/D");
 treeout->Branch("K_PT",&K_PT,"K_PT/D");
 treeout->Branch("K_MINIPCHI2",&K_MINIPCHI2,"K_MINIPCHI2/D");
 treeout->Branch("K_IPCHI2_ORIVX",&K_IPCHI2_ORIVX,"K_IPCHI2_ORIVX/D");
 treeout->Branch("B_ENDVERTEX_CHI2",&B_ENDVERTEX_CHI2,"B_ENDVERTEX_CHI2/D");
 ...
 for(Int_t i=0; i<dsentries; i++)
   {
     ...
     K_MINIPCHI2 = (data->get(i))->getRealValue("K_MINIPCHI2"); 
     K_IPCHI2_ORIVX = (data->get(i))->getRealValue("K_IPCHI2_ORIVX");
     B_ENDVERTEX_CHI2= (data->get(i))->getRealValue("B_ENDVERTEX_CHI2");
...
void MakePlots(RooWorkspace* ws){
  ...
  RooRealVar* B_DTF_M_JpsiConstr = ws->var("B_DTF_M_JpsiConstr");
  RooRealVar* K_MINIPCHI2 = ws->var("K_MINIPCHI2");
  RooRealVar* B_ENDVERTEX_CHI2 = ws->var("B_ENDVERTEX_CHI2");
  RooRealVar* K_IPCHI2_ORIVX = ws->var("K_IPCHI2_ORIVX");

  cout<<"poop9"<<endl;
  //  RooFormulaVar sum_pt("sum_pt","@0+@1",RooArgSet(*K_PT,*Pi_PT));
